        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="edicaMainNav">
                <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('category.index') }}">Жанры</a>
                    </li>
...
<footer class="edica-footer" data-aos="fade-up">
    <div class="container">
        ...
        <div class="footer-bottom-content">
            ...
            <p class="mb-0">© Igor Kokorev. 2022 <a href="https://github.com/igr-ok" target="_blank" rel="noopener noreferrer" class="text-reset">my humble github</a> . Almost all rights reserved.</p>
        </div>
    </div>
</footer>
